...
void time_create(Layer *window_layer, GRect *bounds) {
  home_layer = text_layer_create(GRect(0, 52, bounds->size.w, 50));
  text_layer_set_background_color(home_layer, GColorClear);
  ...
  date_layer = text_layer_create(GRect(0, 0, bounds->size.w, 50));
  text_layer_set_background_color(date_layer, GColorClear);
  text_layer_set_text_color(date_layer, GColorBlack);
  text_layer_set_text(date_layer, "Sun 00:00");
  text_layer_set_font(date_layer, fonts_get_system_font(FONT_KEY_GOTHIC_28_BOLD));
  text_layer_set_text_alignment(date_layer, GTextAlignmentCenter);
  layer_add_child(window_layer, text_layer_get_layer(date_layer));

  away_layer = text_layer_create(GRect(0, 100, bounds->size.w, 50));
  text_layer_set_background_color(away_layer, GColorClear);
  text_layer_set_text_color(away_layer, GColorBlack);
  text_layer_set_text(away_layer, "00:00");
  text_layer_set_font(away_layer, fonts_get_system_font(FONT_KEY_GOTHIC_28_BOLD));
  text_layer_set_text_alignment(away_layer, GTextAlignmentCenter);
